...
const DEFAULT_ROUNDS = [
  {
    ...
    "type": "quiz",
    "title": "День недели",
    "question_text": "Если вчера был понедельник, какой день будет послезавтра?",
    "option_a": "Среда",
    "option_b": "Четверг",
    "option_c": "Пятница",
    "option_d": "Воскресенье",
    "correct_option": "B",
  ...
  },
  {
    ...
    "type": "quiz",
    "title": "Возраст",
    "question_text": "Даниил старше Артёма на 4 года. Вместе им 28 лет. Сколько лет Даниилу?",
    "option_a": "12",
    "option_b": "14",
    "option_c": "16",
    "option_d": "18",
  ...
  },
  {
    ...
    "type": "double",
    "title": "Кодовый замок",
    "question_text": "Первая цифра больше второй на 2. Третья равна сумме первых двух. Сумма всех цифр равна 12. Какая третья цифра?",
    "option_a": "4",
    "option_b": "5",
    "option_c": "6",
    "option_d": "8",
  ...
  },
  {
    ...
    "type": "immunity",
    "title": "Иммунитет",
    "question_text": "Три коробки подписаны неправильно: «яблоки», «апельсины», «смесь». Из какой коробки нужно взять один фрукт, чтобы всё определить?",
    "option_a": "Из «яблоки»",
  ...
  },
  {
    ...
    "type": "trap",
    "title": "Свечи",
    "question_text": "На столе горело 5 свечей. 2 свечи потухли. Сколько свечей останется?",
    "option_a": "0",
    "option_b": "2",
    "option_c": "3",
    "option_d": "5",
  ...
  },
  {
    ...
    "type": "fast",
    "title": "Квадраты",
    "question_text": "Продолжите ряд: 4, 9, 16, 25, ...",
    "option_a": "30",
    "option_b": "32",
    "option_c": "36",
    "option_d": "49",
    ...
    <div class="page">
      <section class="hero">
        <div class="hero-inner">
          ...
          <p class="hero-lead">20 раундов, логические ловушки, мини-игры, спецраунды, 3 жизни и только один победитель.</p>
          <div class="hero-date">
          ...
          <div class="hero-stats">
            ...
            <div class="stat-card"><b>20</b><span>раундов</span></div>
      ...
      <section class="host-layout">
        <aside class="host-side glass">
          ...
          <div class="form-grid">
            ...
            <button class="primary-btn" id="create-game">Создать игру с 20 раундами</button>
          </div>
        ...
        <main class="host-main glass">
          ...
          <details>
            ...
            <p class="tiny">Встроено 20 более сложных раундов. Можно редактировать вопросы, варианты, типы и таймер. Типы: quiz, fast, double, immunity, trap, sudden, reflex, memory.</p>
        ...
        <div class="lobby-dock glass">
          <div class="lobby-mainline">
            <div>
              ...
              <h2>${escapeHtml(state.game.title)}</h2>
              <p class="muted">Ждите команду ведущего. Первый раунд начнётся одновременно для всех игроков.</p>
            </div>
